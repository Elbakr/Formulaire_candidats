...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between rounded-[var(--radius-sm)] border-[1.5px] border-line bg-surface px-3 py-2 text-sm",
      "outline-none focus:border-gold disabled:cursor-not-allowed disabled:opacity-50",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-md border border-line bg-surface shadow-[var(--shadow-lg)]",
