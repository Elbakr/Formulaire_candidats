-- Karim 2026-05-29 : nettoyage contrats v7
...
update public.contract_templates set body_markdown = $contract_v7$
...
$contract_v7$, updated_at = now() where code = 'employee';
...
*Employeur : {{employer_name}} — BCE {{employer_bce}} — ONSS {{employer_onss}} — RC {{employer_rc}} — {{employer_address}}, {{employer_locality}}.*
$contract_v7$, updated_at = now() where code = 'employee_pt';
...
*Employeur : {{employer_name}} — BCE {{employer_bce}} — ONSS {{employer_onss}} — RC {{employer_rc}} — {{employer_address}}, {{employer_locality}}.*
$contract_v7$, updated_at = now() where code = 'student';
