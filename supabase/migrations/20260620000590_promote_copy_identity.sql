-- Karim 2026-05-30 : promote_application_to_employee oubliait de copier
-- l IBAN, NISS, adresse, BIC, etc. du candidate vers l employee.
-- Resultat : champ {{iban}} vide dans les contrats apres embauche.
...
begin
  if new.status = 'hired' and (old.status is distinct from 'hired') then
    ...
    insert into public.employees (
      ...
      start_date,
      -- Karim 2026-05-30 : copie identite + bancaire pour contrat + paye
